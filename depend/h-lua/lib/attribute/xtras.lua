...
hattribute.xtrasSupportEvents = {
    ...
    CONST_EVENT.siphon, CONST_EVENT.beSiphon, CONST_EVENT.skillSiphon, CONST_EVENT.beSkillSiphon,
...
--        { on = CONST_EVENT.beDamage, action = "triggerUnit.spec.crack_fly", odds = 50, val = 100, distance = 300, height = 200, during = 0.5 },
